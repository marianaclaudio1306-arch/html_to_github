...
export default function lau ({ x,y,z}){

// Espacio para colocar los objetos
    
     var loader = new THREE.TextureLoader();
var fotoTextura = loader.load('imagenes/lau.jpeg'); // 👈 cambia esta ruta por tu imagen
...
//scene.add(borde);
    ...
    const LAU= new THREE.Group();
    LAU.add(fotito,marco,borde);
    LAU.position.set(x,y,z);

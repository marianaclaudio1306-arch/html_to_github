...
export default function gml ({ x,y,z}){

// Espacio para colocar los objetos
    var loader = new THREE.TextureLoader();
var fotoTextura = loader.load('imagenes/3.jpeg'); // 👈 cambia esta ruta por tu imagen
...
const GML= new THREE.Group();
    GML.add(fotito,marco,borde);
   GML.position.set(x,y,z);

...
export default function gaby ({ x,y,z}){

// Espacio para colocar los objetos
     var loader = new THREE.TextureLoader();
var fotoTextura = loader.load('imagenes/gaby.jpeg'); // 👈 cambia esta ruta por tu imagen
...
//scene.add(borde);
    ...
    const GABY= new THREE.Group();
    GABY.add(fotito,marco,borde);
    GABY.position.set(x,y,z);
